...
(function () {
  ...
  var DICT = {
    ...
    'reducer': { cat: 'plugin', short: 'Optional, and not built.',
      body: '<p>For reductions the schema vocabulary cannot express. Omit it and the built-in reducer runs what each layer’s <code>aggregate</code> declares, which covers everything named so far.</p>' },
